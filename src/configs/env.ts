  ...
  try {
    ...
    return {
      ...
      conversationBufferPath:
        process.env.CONVERSATION_BUFFER_PATH ?? "data/conversation-buffer.json",
      ...
      databaseBackupSchedule: validateBackupSchedule(
        process.env.DATABASE_BACKUP_SCHEDULE ?? "03:30",
      ),
