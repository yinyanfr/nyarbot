...
const fontPath = fileURLToPath(new URL("../../assets/fonts/SourceHanSans-VF.ttf", import.meta.url));
...
if (!GlobalFonts.registerFromPath(fontPath, fontAlias) || !GlobalFonts.has(fontAlias)) {
